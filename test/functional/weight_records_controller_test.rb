...
class WeightRecordsControllerTest < ActionController::TestCase
  ...
  test "should create weight_record" do
    assert_difference('WeightRecord.count') do
      post :create, weight_record: { component_id: @weight_record.component_id, weight: @weight_record.weight, weight_unit: @weight_record.weight_unit }
    end
  ...
  test "should update weight_record" do
    put :update, id: @weight_record, weight_record: { component_id: @weight_record.component_id, weight: @weight_record.weight, weight_unit: @weight_record.weight_unit }
    assert_redirected_to weight_record_path(assigns(:weight_record))
  end
