...
class ConnectionsControllerTest < ActionController::TestCase
  ...
  test "should create connection" do
    assert_difference('Connection.count') do
      post :create, connection: { confirmed: @connection.confirmed, trainee_id: @connection.trainee_id, trainer_id: @connection.trainer_id }
    end
  ...
  test "should update connection" do
    put :update, id: @connection, connection: { confirmed: @connection.confirmed, trainee_id: @connection.trainee_id, trainer_id: @connection.trainer_id }
    assert_redirected_to connection_path(assigns(:connection))
  end
